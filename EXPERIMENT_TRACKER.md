...
| **7** | `emerald_tiger` | `PENDING (0/13)` | `output/emerald_tiger/` (`output/emerald_tiger/emerald_tiger_all_runs.zip`) | Comprehensive 13-Step Multimodal Backbone & Mediator Flattened Sweep (Anchor C) |
