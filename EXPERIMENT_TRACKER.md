...
| **10** | `demonic_bobcat` | `PENDING (0/3)` | `output/demonic_bobcat/` (`output/demonic_bobcat/demonic_bobcat_all_runs.zip`) | Qwen3-VL 8B MLP Series Rebuild Suite (Anchor C, n=100, MLP Head, 3 Seeds) |
